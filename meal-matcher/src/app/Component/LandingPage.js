  ...
  return (
    <div className={inter.className}>
      ...
      <div className="w-full mt-20 px-4 flex flex-col items-center text-center">
        ...
        <Link
          href="/swipe"
          className="animate-pulse mt-6 text-[#635BFF] text-lg font-medium hover:opacity-80 transition"
        >
          Start Now
        </Link>
      </div>

      <div className=" mt-24 px-6 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-40 text-center">
        <div className="border-solid border-6 border-[#635BFF] rounded-lg p-8">
        ...
        <div className="border-solid border-6 border-[#635BFF] rounded-lg p-8">
          ...
          <p className="text-gray-600 text-sm">
            We handle the group logic so you don’t have to argue about where to
            eat.
          </p>
        </div>
